This Django project includes a user registration form where users provide a username, password, and email. After successful registration, the user is redirected to a login page.
